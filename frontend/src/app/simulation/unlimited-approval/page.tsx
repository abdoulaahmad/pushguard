...
export default function UnlimitedApprovalSimulation() {
    ...
    <div className="min-h-screen" style={{ backgroundColor: 'var(--primary-bg)' }}>
      ...
      <div className="container mx-auto max-w-4xl py-12 px-4">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-bold text-white">🔓 Unlimited Approval Simulation</h1>
        ...
        <div className="card p-8 mb-8">
          {step === 0 && (
            <div>
              <h2 className="text-2xl font-bold text-white mb-4">Unlimited Token Approval Scenario</h2>
              <p className="mb-6 text-white">
                In this simulation, you'll experience how PushGuard detects and prevents a dangerous unlimited 
                token approval that could drain your wallet of all tokens of a specific type.
              </p>
              ...
              <div className="bg-gray-800 rounded-lg p-6 mb-6">
                ...
                <div className="space-y-3">
                  <div className="flex">
                    ...
                    <span className="text-white">Unlimited Token Approval</span>
                  </div>
                  <div className="flex">
                  ...
                  <div className="flex">
                    ...
                    <span className="text-white">All tokens of approved type</span>
                  </div>
                  <div className="flex">
                    <span className="w-32 text-white">Detection Method:</span>
                    <span className="text-white">Approval amount analysis</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-800 rounded-lg p-6 mb-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center mt-1">
                        <div className="w-8 h-8 rounded-full bg-purple-500 flex items-center justify-center mr-2">
                          <span className="text-white text-xs">UNI</span>
                        </div>
                    ...
                    <div>
                      ...
                      <div className="text-red-400 font-bold mt-1">
                        Unlimited approval (2^256 - 1 tokens)
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="text-white mt-1">
                        "Approve UNI tokens for staking rewards"
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-yellow-900 border border-yellow-700 rounded-lg p-4 mb-4">
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <h3 className="text-sm font-bold text-yellow-200">Security Warning</h3>
                      <div className="mt-2 text-sm text-yellow-200">
                        <p>Unlimited token approvals allow contracts to spend all of your tokens of this type. This is extremely dangerous!</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gray-800 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center">
                    ...
                    <span className="text-white">Checking approval amount...</span>
                  </div>
                  <div className="flex items-center">
                    <div className="w-4 h-4 rounded-full bg-yellow-500 mr-3 animate-pulse"></div>
                    <span className="text-white">Analyzing contract reputation...</span>
                  </div>
                  <div className="flex items-center">
                    <div className="w-4 h-4 rounded-full bg-yellow-500 mr-3 animate-pulse"></div>
          ...
          {step === 3 && (
            <div>
              <h2 className="text-2xl font-bold text-white mb-4">⚠️ Critical Threat Detected!</h2>
              <p className="mb-6 text-white">
                PushGuard has identified this as a dangerous unlimited token approval!
              </p>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="mt-2 text-sm text-blue-200">
                        <p>Critical threat: Unlimited token approval detected!</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex">
                    ...
                    <div className="text-white">
                      ...
                      <div>• Contract has moderate reputation</div>
                      <div>• No legitimate reason for unlimited approval</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {step === 4 && (
            <div>
              ...
              {blocked ? (
                <div>
                  <p className="mb-6 text-white">
                    Excellent choice! You've successfully prevented a potentially devastating unlimited token approval.
                  </p>
                  ...
                  <div className="bg-green-900 border border-green-700 rounded-lg p-6 mb-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex">
                        ...
                        <span className="text-white">All UNI tokens in your wallet</span>
                      </div>
                      <div className="flex">
                        <span className="w-32 text-green-300">Estimated Value:</span>
                        <span className="text-white">$12,450.30</span>
                      </div>
                      <div className="flex">
                ...
                <div>
                  <p className="mb-6 text-white">
                    You've chosen to proceed with the transaction. In a real scenario, this could result in the loss of all your UNI tokens.
                  </p>
              ...
              <div className="bg-gray-800 rounded-lg p-6">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span className="text-white">Never approve unlimited token spending unless absolutely necessary</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-white">Always specify exact amounts for token approvals</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">✓</span>
                  ...
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-white">Revoke unlimited approvals for existing contracts</span>
                  </li>
                </ul>
        ...
        <div className="card p-6">
          <h3 className="text-lg font-bold text-white mb-4">About Unlimited Token Approvals</h3>
          <p className="mb-4 text-white">
            Unlimited token approvals are one of the most dangerous threats in Web3. They allow contracts to spend 
            all of your tokens of a specific type, potentially draining your entire balance.
          </p>
          <p className="text-white">
            PushGuard protects against these threats by analyzing approval amounts and flagging any that exceed 
            reasonable thresholds, giving you a chance to prevent potential loss of funds.
          </p>
        </div>
      </div>
