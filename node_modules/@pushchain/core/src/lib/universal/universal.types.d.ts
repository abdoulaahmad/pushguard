...
export interface EthersV5SignerType {
    _signTypedData: (domain: TypedDataDomain, types: Record<string, Array<any>>, value: Record<string, any>) => Promise<string>;
...
export interface EthersV6SignerType {
    ...
    signTypedData: (domain: TypedDataDomain, types: Record<string, Array<any>>, value: Record<string, any>) => Promise<string>;
    provider?: any;
}
/**
