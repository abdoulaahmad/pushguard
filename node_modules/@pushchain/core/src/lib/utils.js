...
Utils.account = {
     ...
     */
    fromChainAgnostic: account_1.fromChainAgnostic,
    convertOriginToExecutor: account_1.convertOriginToExecutor,
    convertExecutorToOriginAccount: account_1.convertExecutorToOriginAccount,
};
Utils.signer = {
    /**
...
Utils.helpers = {
    ...
    encodeTxData({ abi, functionName, args = [], }) {
        ...
        try {
            ...
            const abiInterface = new ethers_1.ethers.Interface(abi);
    ...
    parseUnits(value, exponent) {
        ...
        try {
            ...
            if (fractionalPart.length > actualExponent) {
                throw new Error(`Value has more decimal places (${fractionalPart.length}) than exponent allows (${actualExponent})`);
            }
